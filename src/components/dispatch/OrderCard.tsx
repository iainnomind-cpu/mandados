import { Clock, MapPin, DollarSign, Zap, User, Package, Eye } from 'lucide-react';
...
export default function OrderCard({ order, onAssign, onAutoAssign, onView, assigning }: OrderCardProps) {
    ...
    return (
        <div className="bg-white border border-gray-100 rounded-xl p-4 shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="flex items-center gap-1.5 mb-3">
                ...
                <span className="text-xs text-gray-500 truncate">{itemsPreview}</span>
            </div>
